...
def prepare_playlist_data(DB, train_test_split=0.9):
    ...
    try:
        ...
        track_sentences = [
            ...
            for track_list in train_playlist_agg["track_uids"]
        ]
    ...
    try:
        ...
        genre_sentences = []
        for _, row in train_playlist_agg.iterrows():
            playlist_genres = []
    ...
    return SM.set_index('track_uid'), test_playlist_agg, feature_cols
